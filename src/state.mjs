...
export const STATES = ['DISCOVERED','NORMALIZED','FILTERED_OUT','QUALIFIED','RESUME_PLANNED','RESUME_GENERATED','RESUME_REJECTED','RESUME_VERIFIED','APPLICATION_READY','APPLICATION_IN_PROGRESS','ATTENTION_REQUIRED','SUBMITTED','SUBMISSION_UNCONFIRMED','FAILED','CLOSED'];
const ALLOWED = {
  ...
  APPLICATION_READY:['APPLICATION_IN_PROGRESS'], APPLICATION_IN_PROGRESS:['ATTENTION_REQUIRED','SUBMITTED','SUBMISSION_UNCONFIRMED','FAILED'],
